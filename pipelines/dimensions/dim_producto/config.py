...
SELECT_ORIGEN = """
    ...
    INNER JOIN dbo.arbol asubpp ON asubpp.ARBOL_ID = arbol.CO_PADRE
    INNER JOIN ma00 ON ma00.codigo = ma04.Y04033 AND ma00.clasif = '0003'
    INNER JOIN MAE.subfamilia ON subfamilia.arbol_id = arbol.ARBOL_ID
    INNER JOIN MAE.clase ON clase.idclase = ma04.idclase AND clase.idsubfamilia = subfamilia.idsubfamilia
