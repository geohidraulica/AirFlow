...
def load():
    ...
    # RENAME COLUMNS
    # --------------------------------------------------------------
    rows_insert = etl_mgr.rename_columns(src_rows, COLUMN_MAPPING)
    ...
    etl_mgr.execute_sql(delete_sql, sql_destino)
...
# python3 -m pipelines.operational.rrhh.horario_empleado.load
