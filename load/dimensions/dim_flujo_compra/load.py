...
from load.dimensions.dim_flujo_compra.config import TMP_CSV, COLUMN_MAPPING
from load.dimensions.dim_flujo_compra.extrac import extract_to_csv
...
def stream_load():
    ...
    url = (
        ...
        f"/api/{CONFIG['starrocks']['database']}/DimFlujoCompra/_stream_load"
    )
    ...
    headers = {
        ...
        "label": f"dim_flujo_compra{int(time.time())}",
        "format": "csv",
        "column_separator": "|",
...
#python -m load.dimensions.dim_flujo_compra.load
