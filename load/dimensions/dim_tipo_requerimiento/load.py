...
from load.dimensions.dim_tipo_requerimiento.extrac import extract_to_csv
...
def stream_load():
    ...
    url = (
        ...
        f"/api/{CONFIG['starrocks']['database']}/DimTipoRequerimiento/_stream_load"
    )
    ...
    headers = {
        ...
        "label": f"dim_tipo_requerimiento_{int(time.time())}",
        "format": "csv",
        "column_separator": "|",
...
#python -m load.dimensions.dim_tipo_requerimiento.load
