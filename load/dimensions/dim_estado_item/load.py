...
from load.dimensions.dim_estado_item.extrac import extract_to_csv
...
def stream_load():
    ...
    url = (
        ...
        f"/api/{CONFIG['starrocks']['database']}/DimEstadoItem/_stream_load"
    )
    ...
    headers = {
        ...
        "label": f"dim_estado_item_{int(time.time())}",
        "format": "csv",
        "column_separator": "|",
...
#python -m load.dimensions.dim_estado_item.load
