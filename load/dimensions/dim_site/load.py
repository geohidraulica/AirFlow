...
from load.dimensions.dim_site.extrac import extract_to_csv
...
def stream_load():
    ...
    url = (
        ...
        f"/api/{CONFIG['starrocks']['database']}/DimSite/_stream_load"
    )
    ...
    headers = {
        ...
        "label": f"dim_site_{int(time.time())}",
        "format": "csv",
        "column_separator": "|",
...
#python -m load.dimensions.dim_site.load
