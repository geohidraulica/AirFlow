...
from load.dimensions.dim_producto.extrac import extract_to_csv
...
def stream_load():
    ...
    url = (
        ...
        f"/api/{CONFIG['starrocks']['database']}/DimProducto/_stream_load"
    )
    ...
    headers = {
        ...
        "label": f"dim_producto_{int(time.time())}",
        "format": "csv",
        "column_separator": "|",
...
#python -m load.dimensions.dim_producto.load
