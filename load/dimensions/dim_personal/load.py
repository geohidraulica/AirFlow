...
from load.dimensions.dim_personal.config import TMP_CSV, COLUMN_MAPPING
from load.dimensions.dim_personal.extrac import extract_to_csv
...
def stream_load():
    ...
    url = (
        ...
        f"/api/{CONFIG['starrocks']['database']}/DimPersonal/_stream_load"
    )
    ...
    headers = {
        ...
        "label": f"dim_personal_{int(time.time())}",
        "format": "csv",
        "column_separator": "|",
...
#python -m load.dimensions.dim_personal.load
