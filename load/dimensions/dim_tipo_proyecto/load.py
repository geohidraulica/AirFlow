...
from load.dimensions.dim_tipo_proyecto.config import TMP_CSV, COLUMN_MAPPING
from load.dimensions.dim_tipo_proyecto.extrac import extract_to_csv
...
def stream_load():
    ...
    url = (
        ...
        f"/api/{CONFIG['starrocks']['database']}/DimTipoProyecto/_stream_load"
    )
    ...
    headers = {
        ...
        "label": f"dim_proyecto_{int(time.time())}",
        "format": "csv",
        "column_separator": "|",
...
#python -m load.dimensions.dim_tipo_proyecto.load
