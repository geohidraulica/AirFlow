...
from load.dimensions.dim_proveedor.config import TMP_CSV, COLUMN_MAPPING
from load.dimensions.dim_proveedor.extrac import extract_to_csv
...
def stream_load():
    ...
    url = (
        ...
        f"/api/{CONFIG['starrocks']['database']}/DimProveedor/_stream_load"
    )
    ...
    headers = {
        ...
        "label": f"dim_proveedor_{int(time.time())}",
        "format": "csv",
        "column_separator": "|",
...
#python -m load.dimensions.dim_proveedor.load
