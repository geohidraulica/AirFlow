...
from load.dimensions.dim_estado_oc.config import TMP_CSV, COLUMN_MAPPING
from load.dimensions.dim_estado_oc.extrac import extract_to_csv
...
def stream_load():
    ...
    url = (
        ...
        f"/api/{CONFIG['starrocks']['database']}/DimEstadoOc/_stream_load"
    )
    ...
    headers = {
        ...
        "label": f"dim_estado_oc_{int(time.time())}",
        "format": "csv",
        "column_separator": "|",
...
#python -m load.dimensions.dim_estado_oc.load
