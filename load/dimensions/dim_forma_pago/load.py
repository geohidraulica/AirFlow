...
from load.dimensions.dim_forma_pago.config import TMP_CSV, COLUMN_MAPPING
from load.dimensions.dim_forma_pago.extrac import extract_to_csv
...
def stream_load():
    ...
    url = (
        ...
        f"/api/{CONFIG['starrocks']['database']}/DimFormaPago/_stream_load"
    )
    ...
    headers = {
        ...
        "label": f"dim_forma_pago_{int(time.time())}",
        "format": "csv",
        "column_separator": "|",
...
#python -m load.dimensions.dim_forma_pago.load
