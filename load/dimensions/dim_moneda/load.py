...
from load.dimensions.dim_moneda.config import TMP_CSV, COLUMN_MAPPING
from load.dimensions.dim_moneda.extrac import extract_to_csv
...
def stream_load():
    ...
    url = (
        ...
        f"/api/{CONFIG['starrocks']['database']}/DimMoneda/_stream_load"
    )
    ...
    headers = {
        ...
        "label": f"dim_moneda_{int(time.time())}",
        "format": "csv",
        "column_separator": "|",
...
#python -m load.dimensions.dim_moneda.load
